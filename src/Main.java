	...
	public static void main(String[] args) {
		...
		try {
			...
			String sql2 = "insert into g_artists (name, a_type, a_year, debut, regdate)" 
					+ "values ('스텔라장','여성','2010년대','2014년',datetime('now','localtime'));"
					+"insert into g_artists (name, a_type, a_year, debut, regdate)" 
					+ "values ('치즈','여성','2010년대','2011년',datetime('now','localtime'));"
					+"insert into g_artists (name, a_type, a_year, debut, regdate)" 
					+ "values ('선우정아','여성','2000년대, 2010년대','2006년',datetime('now','localtime'));";
